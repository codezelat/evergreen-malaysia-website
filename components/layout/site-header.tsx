          ...
          <ul className="flex items-center gap-8">
            {navigation.map((item) => (
              <li key={item.label}>
                <Link
                  href={item.href}
                  className="focus-ring relative py-3 text-[0.69rem] font-semibold tracking-[0.025em] text-white/85 transition-colors after:absolute after:inset-x-0 after:bottom-1 after:h-px after:origin-left after:scale-x-0 after:bg-evergreen-500 after:transition-transform hover:text-white hover:after:scale-x-100"
                >
                  {item.label}
                </Link>
              </li>
            ...
            {navigation.map((item) => (
              <li key={item.label}>
                <Link
                  ...
                  className="focus-ring flex min-h-16 items-center text-xl font-semibold text-white"
                >
                  {item.label}
                </Link>
              </li>
